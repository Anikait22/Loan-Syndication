    ...
    $.each(result, (index, value) => {
      ...
      if(value.isParticipating) {
        ...
        if(value.isAdmin){
          $('#participating_banks_container').append(`
          <div>
            <label for="" class="form-label">Admin Bank Name: </label>
    ...
    .then(() => {
      ...
      .then(_stage => {
        ...
        if(_stage < 2) {
          ...
          $('#sanction').hide();
          $('#Completed').show();
          $('#block_transaction_details_container').hide();
          ...
          .then((_adminBank) => {
            ...
            .then(_proposals => {
              ...
              .call({from: adminBank})
              .then(_winning => {
                getTransactionDetails(_proposals[_winning]);
              });
            });
          });
        }
